    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <span className="flex items-center gap-1.5">✅ {t("hero.rera")}</span>
            <span className="w-1 h-1 bg-cream/30 rounded-full" />
            <span className="flex items-center gap-1.5">🏗️ {t("hero.projects_done")}</span>
            <span className="w-1 h-1 bg-cream/30 rounded-full" />
            <span className="flex items-center gap-1.5">👨‍👩‍👧‍👦 {t("hero.families")}</span>
          </motion.div>
          ...
          >
            <Link to="/projects">
              <Button variant="hero" size="lg">{t("hero.view_projects")}</Button>
            </Link>
